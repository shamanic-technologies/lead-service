...
export const REPLY_QUALIFICATION_SERVICE_URL = required("REPLY_QUALIFICATION_SERVICE_URL");
export const REPLY_QUALIFICATION_SERVICE_API_KEY = required("REPLY_QUALIFICATION_SERVICE_API_KEY");
